          ...
          <header className="mb-10 sm:mb-14">
            <div className="flex flex-col justify-between gap-8 md:flex-row md:items-end">
              ...
              <p className="max-w-sm text-sm leading-7 text-karsa-black/50 sm:text-base">
                Dokumentasi perjalanan Karsa dalam bergerak bersama
          ...
          {filteredGalleries.map((gallery, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <article>
                    <div className="relative aspect-[4/3] overflow-hidden rounded-xl bg-[#f3f3f1]">
                      <Image
                        src={gallery.image}
                        alt={gallery.title}
                        fill
                    ...
                    <div className="pt-4">
                      <div className="mb-3 flex items-center gap-2">
                        ...
                        />
                        <span
                          className={`text-[11px] font-semibold uppercase tracking-[0.08em] ${accent.text}`}
                        >
                          {gallery.category}
                        </span>
