  ...
  useEffect(() => {
    const fetchGalleries = async () => {
      try {
        ...
        const selectedGallery = result.data.find(
          (item) => item.slug === galleryId
        )
        ...
        <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
          ...
          <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-12">
            <div className="lg:col-span-7">
              ...
              <div className="mt-4 h-12 w-3/4 animate-pulse rounded bg-gray-100" />
            </div>
          ...
          <div className="mt-10 aspect-[16/8] animate-pulse rounded-2xl bg-gray-100" />

          <div className="mt-16">
            <div className="h-5 w-32 animate-pulse rounded bg-gray-100" />
            <div className="mt-4 h-24 max-w-xl animate-pulse rounded bg-gray-100" />
          </div>
        </div>
      </main>
    )
            ...
            >
              <div>
                <div className="mb-4 flex items-center gap-2">
                  ...
                  <span
                    className={`text-[11px] font-bold uppercase tracking-[0.22em] ${accent.text}`}
                  >
                    {gallery.category}
                  </span>
                </div>
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            {gallery.images.map((image, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={`relative overflow-hidden rounded-2xl bg-gray-100 ${isLarge
                      ? "aspect-[16/8]"
                      : "aspect-[4/3]"
                      }`}
                  >
        ...
        <section className="mt-20 border-y border-karsa-black/10 sm:mt-28">
          <div className="grid grid-cols-2 sm:grid-cols-4">
            ...
            <div className="border-r border-b border-karsa-black/10 p-5 sm:border-b-0 sm:p-6">
              <p className="text-[10px] font-bold uppercase tracking-[0.12em] text-karsa-black/30">
                Kategori
              </p>
        ...
        {nextGallery && (
          <section className="mt-20 border-t border-karsa-black/10 pt-10 sm:mt-28">
            <div className="flex flex-col gap-7 sm:flex-row sm:items-end sm:justify-between">
              ...
              <Link
                href="/galeri"
                className="inline-flex items-center gap-2 text-sm font-semibold text-karsa-primary"
              >
                Semua galeri
